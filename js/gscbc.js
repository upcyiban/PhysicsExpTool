...
$(document).ready(function(){
    $('#gscbcbtn').click(function(){
        ...
        var a11c = 100*(a11-a11z)+a11z*60;
        var a12c = 100*(a12-a12z)+a12z*60;
        var a21c = 100*(a21-a21z)+a21z*60;
        var a22c = 100*(a22-a22z)+a22z*60;
        var c = Math.abs(0.25*(a21c - a11c + a22c - a12c));
        c = c/60/180*Math.PI;
        ...
        $("#record").append("<tr> <td style='word-break: break-all'>"+a11+"</td> " +
            ...
            "<td style='word-break: break-all'>"+l+"</td> </tr>");
    });
});
