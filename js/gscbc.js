...
$(document).ready(function(){
    $('#gscbcbtn').click(function(){
        ...
        var a22 = $('#angle4').val();
        var k = $('#k').val();
        var a11z = parseInt(a11);//提取整数部分
        var a12z = parseInt(a12);
        var a21z = parseInt(a21);
        var a22z = parseInt(a22);
        var a11c = (a11-a11z)+a11z*60;//alert(a11c);
        var a12c = (a12-a12z)+a12z*60;//alert(a12c);
        var a21c = (a21-a21z)+a21z*60;//alert(a21c);
        var a22c = (a22-a22z)+a22z*60;//alert(a22c);
